...
registerMooseObject("TestTrussApp", StressDivergenceTensorsTruss2);

defineLegacyParams(StressDivergenceTensorsTruss2);

InputParameters
StressDivergenceTensorsTruss2::validParams()
{
...
StressDivergenceTensorsTruss2::StressDivergenceTensorsTruss2(const InputParameters & parameters)
  : Kernel(parameters),
...
void
StressDivergenceTensorsTruss2::initialSetup()
{
  _orientation = &_subproblem.assembly(_tid).getFE(FEType(), 1)->get_dxyzdxi();
}

void
StressDivergenceTensorsTruss2::computeResidual()
{
...
Real
StressDivergenceTensorsTruss2::computeStiffness(unsigned int i, unsigned int j)
{
  RealGradient orientation((*_orientation)[0]);
  orientation /= orientation.norm();
...
void
StressDivergenceTensorsTruss2::computeJacobian()
{
...
void
StressDivergenceTensorsTruss2::computeOffDiagJacobian(MooseVariableFEBase & jvar)
{
